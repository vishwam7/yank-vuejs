...
var KTApexChartsDemo = {
    init: function () {
        ...
        (e = {
            ...
            new ApexCharts(document.querySelector("#chart_1"), e).render(),
            (function () {
                var e = {
                    series: [
            ...
            (function () {
                var e = {
                    ...
                    yaxis: [
                        { axisTicks: { show: !0 }, axisBorder: { show: !0, color: primary }, labels: { style: { colors: primary } }, title: { text: "Income (thousand crores)", style: { color: primary } }, tooltip: { enabled: !0 } },
                        {
                            seriesName: "Income",
                            opposite: !0,
                            axisTicks: { show: !0 },
            ...
            (function () {
                var e = {
                    series: [
                        {
                            data: [
                                { x: "Analysis", y: [new Date("2019-02-27").getTime(), new Date("2019-03-04").getTime()], fillColor: primary },
                                { x: "Design", y: [new Date("2019-03-04").getTime(), new Date("2019-03-08").getTime()], fillColor: success },
                                { x: "Coding", y: [new Date("2019-03-07").getTime(), new Date("2019-03-10").getTime()], fillColor: info },
                                { x: "Testing", y: [new Date("2019-03-08").getTime(), new Date("2019-03-12").getTime()], fillColor: warning },
                                { x: "Deployment", y: [new Date("2019-03-12").getTime(), new Date("2019-03-17").getTime()], fillColor: danger },
                            ],
                        },
                    ],
                    ...
                    dataLabels: {
                        ...
                        formatter: function (e, a) {
                            var t = a.w.globals.labels[a.dataPointIndex],
                                n = moment(e[0]),
            ...
            (function () {
                var e = {
                    series: [
                        ...
                        { name: "Bubble4", data: generateBubbleData(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 60 }) },
                    ],
                ...
                var e = {
                    ...
                    plotOptions: {
                        heatmap: {
                            ...
                            colorScale: {
                                ranges: [
                                    { from: -30, to: 5, name: "low", color: success },
                                    { from: 6, to: 20, name: "medium", color: primary },
                                    { from: 21, to: 45, name: "high", color: warning },
                                    { from: 46, to: 55, name: "extreme", color: danger },
                                ],
                            },
                        },
                    },
