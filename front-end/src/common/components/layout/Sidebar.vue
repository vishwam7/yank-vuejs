<template>
	<div
		id="kt_quick_user"
		class="offcanvas1 offcanvas1-right p-10"
		:class="showSideNav"
	>
		<!--begin::Header-->
		<div
			class="offcanvas1-header d-flex align-items-center justify-content-between pb-5"
		>
		...
		<!--end::Header-->
		<!--begin::Content-->
		<div class="offcanvas1-content pr-5 mr-n5">
			<!--begin::Header-->
			<div class="d-flex align-items-center mt-5">
				<div class="symbol symbol-100 mr-5">
					<div
						class="symbol-label"
						v-bind:style="avatarBackgroundImage"
					></div>
			...
			<div class="navi navi-spacer-x-0 p-0">
				<!--begin::Item-->
				<a
					href="/metronic/demo1/custom/apps/user/profile-1/personal-information.html"
					class="navi-item"
				>
					<div class="navi-link">
				...
				<!--begin::Item-->
				<a
					href="/metronic/demo1/custom/apps/user/profile-3.html"
					class="navi-item"
				>
					<div class="navi-link">
						<div class="symbol symbol-40 bg-light mr-3">
				...
				<!--begin::Item-->
				<a
					href="/metronic/demo1/custom/apps/user/profile-2.html"
					class="navi-item"
				>
					<div class="navi-link">
						<div class="symbol symbol-40 bg-light mr-3">
				...
				<!--begin::Item-->
				<a
					href="/metronic/demo1/custom/apps/userprofile-1/overview.html"
					class="navi-item"
				>
					<div class="navi-link">
						<div class="symbol symbol-40 bg-light mr-3">
			...
			<div>
				...
				>
					...
					<span
						class="font-weight-bolder text-danger py-1 font-size-lg"
						>-27%</span
					>
				</div>
				<!--end::Item-->
	...
	data() {
		return {
			avatarBackgroundImage: {
				backgroundImage: `url(${require("@/assets/media/users/300_21.jpg")})`,
			},
		};
	},
	computed: {
		showSideNav() {
			...
			console.log(this.sideNav && "offcanvas1-on");
			return this.sideNav && "offcanvas1-on";
		},
	},
	props: {
		sideNav: {
